...
<p align="center"><img src="https://github.com/theislab/CellHermes/blob/main/img/Fig. 1.png" alt="CellHermes" width="900px" /></p> 
...
| [CellHermes-T-Cell-Reactivity](https://huggingface.co/EthanGao123/CellHermes-T-Cell-Reactivity-v1.0) | Instruction fine-tuning | Instruction-tuned model adapter for T cell tumor-reactivity prediction task  |
| [CellHermes-CoT-SFT](https://huggingface.co/EthanGao123/CellHermes-CoT-SFT) | Instruction fine-tuning | Instruction-tuned model adapter for T cell CoT tumor-reactivity prediction task  |
| [CellHermes-CoT-RL](https://huggingface.co/EthanGao123/CellHermes-CoT-RL) | Reinforcement learning | RL derived model adapter for T cell CoT tumor-reactivity prediction task  |
